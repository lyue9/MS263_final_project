...
Repository Layout:
This repository contains a folder called Figures, where .png files of all figures produced will go, the initial datasets used in .csv or .tsv format, the main project notebook in an .ipynb file, and .py files with functions used in the project. 
